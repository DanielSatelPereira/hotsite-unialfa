...
<head>
    ...
    <!-- CSS personalizado -->
    <link rel="stylesheet" href="/php-frontend/css/style.css">
</head>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarConteudo">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="/php-frontend/index.php">Home</a>
                    </li>
                    <!-- Você pode adicionar mais menus aqui -->
                </ul>

                <!-- Campo de busca + botão -->
                <form class="d-flex me-3" role="search" method="GET" action="/php-frontend/pages/eventos.php">
