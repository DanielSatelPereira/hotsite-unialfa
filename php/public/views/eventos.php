    ...
    <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card h-100 border-0 shadow-sm">
                ...
                <div class="card-footer bg-white border-0">
                    <a href="eventos_detalhe.php?id=1" class="btn text-white w-100" style="background-color: #0511F2;">
        ...
        <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card h-100 border-0 shadow-sm">
                ...
                <div class="card-footer bg-white border-0">
                    <a href="eventos_detalhe.php?id=2" class="btn text-white w-100" style="background-color: #0511F2;">
                        <i class="fas fa-info-circle me-1"></i> Detalhes
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card h-100 border-0 shadow-sm">
                ...
                <div class="card-footer bg-white border-0">
                    <a href="eventos_detalhe.php?id=3" class="btn text-white w-100" style="background-color: #0511F2;">
                        <i class="fas fa-info-circle me-1"></i> Detalhes
                    </a>
                </div>
            </div>
